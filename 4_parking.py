...
def callback(data):
    ...
    global medidadetras
    medidadetras = data.ranges[210]


    global medidamedio
    medidamedio = data.ranges[270]

    global carro
    carro = data.ranges[270:300]
    carro = np.array (carro)
    carro = carro[carro<0.4]
    print('arreglo obs', carro)

    global autonomo
    autonomo = 1

    print('obstaculo frente', medidafrente)
